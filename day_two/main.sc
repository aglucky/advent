...
class Hand(var blue: Int, var green: Int, var red: Int):
    ...
    def this(line: String) = {
        ...
        def processColor(colors: Array[String], colorToFind: String, setColorVal: Int => Unit): Unit = {
            val num = colors.collectFirst {
                case colorStr if colorStr.contains(colorToFind) => colorStr.filter(_.isDigit).toInt
            }.getOrElse(0)
